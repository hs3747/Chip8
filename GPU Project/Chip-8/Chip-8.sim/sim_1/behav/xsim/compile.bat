...
REM
REM Generated by Vivado on Thu Mar 12 18:17:11 -0400 2026
...
echo "xvhdl --incr --relax -prj tb_vga_sync_vhdl.prj"
call xvhdl  --incr --relax -prj tb_vga_sync_vhdl.prj -log xvhdl.log
