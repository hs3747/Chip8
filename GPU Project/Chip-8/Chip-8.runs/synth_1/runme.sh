...
HD_PWD='D:/GPU Project/Chip8/GPU Project/Chip-8/Chip-8.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Top_Entity.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Top_Entity.tcl
